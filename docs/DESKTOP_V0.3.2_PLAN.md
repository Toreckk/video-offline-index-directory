...
7. In progress: application and one same-format upgrade QA pass; freeze release notes/changelog, confirm which installer format was tested, complete the other package's smoke test, and obtain explicit merge approval.
