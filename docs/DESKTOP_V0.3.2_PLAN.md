...
7. Done with recorded exception: application and NSIS upgrade QA pass, release notes/changelog are frozen, and the maintainer explicitly accepts build-time WiX validation in place of the MSI runtime smoke test for this release.
8. In progress: merge the explicitly approved proposal and verify automated v0.3.2 publication.
