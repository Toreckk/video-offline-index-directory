...
| R15 · P2 · confirmed gap | No repository LICENSE or contributor/security guidance at baseline. GitHub About still describes a browser-only app under the dotted name. | Maintainer chooses license and distribution rights; add contribution/support templates and private security-report instructions; update About when publishing docs. No license was selected on the maintainer's behalf. |
